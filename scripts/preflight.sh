...
if "$PY" -c "import pytest" 2>/dev/null; then
  ...
  for t in backend/tests/test_prediction_markets.py \
           ...
           backend/tests/test_clob_order_timeout.py \
           ...
           backend/tests/test_spike_robustness_surface.py \
           backend/tests/test_datetime_tz_consistency.py \
           backend/tests/test_scan_loop_liveness.py \
           backend/tests/test_frozen_corpus_replay.py \
           backend/tests/test_fetch_spike_corpus.py \
           backend/tests/test_exp010_cost_realism.py \
           backend/tests/test_capacity.py \
           backend/tests/test_half_spread.py \
           backend/tests/test_rescore_with_spread.py; do
