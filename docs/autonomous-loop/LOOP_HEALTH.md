...
LOOP_HEALTH:
  project: LLM-Quant
  as_of: 2026-07-02
  last_run: 2026-07-02          # 3rd factory run of the day — the LIVE-FREEZE fix (#156 category coherence), persist-FK hardening + FK-blind-gate test (#157), artifact freshness (#158)
  last_deep_audit: 2026-07-02   # 8-Haiku skeptical scout sweep (category-freeze · FK-persist-ground-truth · risk/exec · security · artifact-freshness · data-parser · tests-coverage · learning-wiring) ran THIS factory run (3rd of the day)
