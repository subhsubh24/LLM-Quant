...
LOOP_HEALTH:
  project: LLM-Quant
  as_of: 2026-07-02
  last_run: 2026-07-02          # 4th factory run of the day — the DATA/INTEGRITY cluster: A6 HF fetcher (#168) + A7 point-in-time sampling (#169) + A3 Kalshi candlesticks fix (#170) + F10 regime-slice report (#171) + kelly NaN guard (#172)
  last_deep_audit: 2026-07-02   # 8-Haiku skeptical scout sweep (A6-feasibility · A7-feasibility · A3-candlestick · F10-feasibility · security · correctness/side-effect · data-parser/leakage · anti-scarcity) ran THIS factory run (4th of the day)
  ...
  validation:                   # self-validation capability readiness — refresh every run from `check_self_validation.py --readiness`
    ...
    capabilities_total: 11      # +1: paper_trading_forward (forward paper cycle on real markets); llm_analysis + polymarket_market_data upgraded to dual-validated (mock in gate + real in the non-blocking live smoke)
